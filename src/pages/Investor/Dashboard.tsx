...
import { Bell, Bitcoin, ChevronRight, FolderOpen, PieChart, TrendingUp } from "lucide-react";
...
const recommendations = [
  { id: 1, title: "CEO: Engr Divine", description: "Expert in AI & Robotics", image: `${images.Logo}` },
  { id: 2, title: "CTO: Engr Divine", description: "Funding early-stage tech", image: `${images.Logo}` },
  { id: 3, title: "CPO: Engr Divine", description: "Legal advisor for startups", image: `${images.Logo}` },
];
...
function RecommendationCard({ title, description, image }: { title: string; description: string; image: string }) {
  return (
    <div className="bg-purple-100 rounded-xl shadow-md  w-64 p-4 pr-4 py-15 flex flex-col items-center text-center">
...
export function Dashboard() {
  const stats = [
    { icon: <Bitcoin size={30} />, amount: "Ξ 4,500", label: "Total Invested" },
    { icon: <FolderOpen size={30} />, amount: "3", label: "Active Investments" },
    { icon: <PieChart size={30} />, amount: "5", label: "Opportunities Viewed" },
    { icon: <TrendingUp size={30} />, amount: "12%", label: "Avg. ROI" },
  ]
      ...
      <div className="bg-white pt-18 px-5">
        ...
        <div className="py-4">
          <Link to="/projects" className="flex justify-between items-center">
            <span className="font-poppins text-[22px] font-medium">Invested Projects</span>
            <ChevronRight />
          </Link>
          <div className="pt-4">
